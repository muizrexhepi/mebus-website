...
export const metadata: Metadata = {
  title: "Contact Support | Mebus - Your Reliable Bus Booking Service",
  description:
    "Get in touch with Mebus support for all your bus booking needs. We offer 24/7 customer support, easy online booking, and hassle-free travel experiences.",
};
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-8 xl:px-0 pt-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
        <div className="space-y-8">
          <ContactInfo
            ...
            content={
              <div className="space-y-2">
                <p>Toll-Free: 1-800-MEBUS-01</p>
                <p>International: +1-555-MEBUS-02</p>
          ...
          <ContactInfo
            ...
            content={
              <div className="space-y-2">
                <p>General Inquiries: support@mebus.com</p>
                <p>Booking Assistance: bookings@mebus.com</p>
          ...
          <ContactInfo
            ...
            content={
              <div className="space-y-2">
                <p>456 Mebus Terminal, Suite 789</p>
      ...
      {/* <div className="mb-16">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="font-semibold text-lg mb-2">
              What amenities are available on Mebus?
            </h3>
            <p className="text-gray-600">
              Mebus offers free Wi-Fi, power outlets, onboard entertainment,

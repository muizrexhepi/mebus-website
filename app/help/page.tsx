            ...
            <CardContent>
              <Accordion type="single" collapsible>
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    We offer reliable and comfortable bus transportation
                    services across multiple cities. Our fleet consists of
                    modern buses equipped with amenities such as Wi-Fi, power
                    outlets, and onboard entertainment.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-3">
                  ...
                  <AccordionContent>
                    Each passenger is allowed one piece of luggage (max. 20kg)
                    for the luggage compartment and one piece of hand luggage
                    (max. 7kg) to take on board. Additional or oversized luggage
                ...
                <AccordionItem value="item-4">
                  ...
                  <AccordionContent>
                    Only service animals are allowed on our buses. Pets,
                    including emotional support animals, are not permitted for
            ...
            <CardContent>
              <Accordion type="single" collapsible>
                ...
                <AccordionItem value="item-3">
                  ...
                  <AccordionContent>
                    Refunds are processed within 5-10 business days, depending
                    on your payment method. The refund will be issued to the
                    original form of payment used for the booking.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-4">

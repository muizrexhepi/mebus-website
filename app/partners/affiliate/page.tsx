...
export const metadata: Metadata = {
  title: "MeBus | Affiliate Program",
  description:
    "Join the MeBus Affiliate Program and earn commissions by promoting our bus ticket booking service.",
};
    ...
    <div className="mx-auto xl:px-0 pt-20">
      ...
      <section className="flex flex-col lg:flex-row items-center justify-between gap-12 py-16 max-w-6xl mx-auto px-4 sm:px-8 xl:px-0">
        <div className="lg:w-1/2">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Become a MeBus affiliate and earn commissions by promoting our bus
      ...
      <section className="py-16 flex max-w-6xl mx-auto flex-col lg:flex-row items-center justify-between gap-12 px-4 sm:px-8 xl:px-0">
        <div className="lg:w-1/2">
          <h2 className="text-3xl font-semibold mb-4">
            How to become a MeBus affiliate
          </h2>
          <p className="mb-8 text-lg">
            Start earning commissions with MeBus in just a few simple steps
          </p>
          <div className="space-y-8">
            {[
              ...
              },
              {
                title: "Promote",
                description:
                  "Use your unique affiliate link and promotional materials to advertise MeBus to your audience.",
              },
              {
                title: "Earn",
                description:
      ...
      <section className="py-16 bg-primary max-w-6xl mx-auto text-white text-center rounded-lg">
        ...
        <p className="mb-8 max-w-2xl mx-auto text-lg px-4 xl:px-0">
          Join the MeBus Affiliate Program today and start earning commissions

...
export const metadata = {
  title: "Mebus - Discounts and Offers",
  description:
    "Discover exclusive discounts, deals, and special offers for your next bus trip with Mebus. Save more on your travels today!",
  keywords:
    "Mebus, Discounts, Bus Deals, Offers, Special Offers, Bus Travel Savings, Travel Discounts",
  authors: [{ name: "Mebus" }],
  robots: "index, follow",
  openGraph: {
    title: "Mebus - Discounts and Offers",
    description:
      "Explore Mebus discounts and special offers to save on your bus bookings. Check out the latest deals today!",
    url: "https://www.mebus.com/discounts",
    type: "website",
    images: [
      {
        url: "https://www.mebus.com/images/discounts-banner.jpg",
        width: 1200,
        height: 630,
        alt: "Mebus Discounts and Offers",
      },
    ],
  },
};
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-8 xl:px-0 pt-32">
      ...
      <div className="mt-12">
        ...
        <ol className="list-decimal list-inside space-y-2">
          <li>Choose your desired trip on the Mebus app or website</li>
      ...
      <div className="mt-12">
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li>
            Mebus reserves the right to modify or cancel offers at any time
          </li>
          <li>
